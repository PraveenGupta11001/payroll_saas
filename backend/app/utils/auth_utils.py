...
SECRET_KEY = "payroll-saas-super-secret-jwt-key-2026-change-me-in-production"
ALGORITHM = "HS256"
...
def require_org_role(allowed_roles: list[str]):
    """
    Dependency to check if the current user has the required role in a specific organization.
    Expects 'org_id' as a query parameter or header.
    """
    def _role_checker(
        org_id: int, 
